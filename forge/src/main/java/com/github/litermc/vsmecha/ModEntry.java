...
import com.github.litermc.vsmecha.platform.ForgeConfigFile;
...
public class ModEntry {
	...
	public static void onServerTick(final TickEvent.ServerTickEvent event) {
		switch (event.phase) {
		case START -> VSMechaListeners.preServerTick(event.getServer());
		case END -> VSMechaListeners.postServerTick(event.getServer());
		}
	}
